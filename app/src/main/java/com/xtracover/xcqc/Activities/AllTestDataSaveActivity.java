...
public class AllTestDataSaveActivity extends AppCompatActivity implements View.OnClickListener {
...
//        System.out.println("Service Key :- " + str_ServiceKey);
...
//            gsonJsonObjectValidate = (JsonObject) jsonParser.parse(jsonMain.toString());
    ...
    private void getTestResultStatusBySession() {
        try {
            ...
            System.out.println("Device Temp Data :- " + deviceTemperature);
            System.out.println("Device Charging Data :- " + chargingTest + "Earphone Jack Connected Status :- " + earphoneJack);

            JSONObject testedJsonObj = null;
            HashMap<String, String> testedJsonParam = new HashMap<String, String>();

            testedJsonParam.put("Network_Signal_sim1", networkSignalSim1);
            testedJsonParam.put("Network_Signal_sim2", networkSignalSim2);
            testedJsonParam.put("WiFi", wiFi);
            testedJsonParam.put("Internet", internet);
            testedJsonParam.put("GPS", gPS);
            testedJsonParam.put("Back_Camera", backCamera);
            testedJsonParam.put("Front_Camera", frontCamera);
            testedJsonParam.put("Camera_Auto_Focus", cameraAutoFocus);
            testedJsonParam.put("Back_Video_Recording", backVideoRecording);
            testedJsonParam.put("Front_Video_Recording", frontVideoRecording);
            testedJsonParam.put("Bluetooth", bluetooth);
            testedJsonParam.put("audioPlakbackTest", audioPlakbackTest);
            testedJsonParam.put("Battery", battery);
            testedJsonParam.put("Internal_Storage", internalStorage);
            testedJsonParam.put("External_Storage", externalStorage);
            testedJsonParam.put("Gyroscope", gyroscope);
            testedJsonParam.put("GyroscopeGaming", gyroscopeGaming);
            testedJsonParam.put("Gravity", gravity);
            testedJsonParam.put("Humidity", humidity);
            testedJsonParam.put("Motion_Detector", motionDetector);
            testedJsonParam.put("Step_Detector", stepDetector);
            testedJsonParam.put("Step_Counter", stepCounter);
            testedJsonParam.put("Light", light);
            testedJsonParam.put("Infrared", infrared);
            testedJsonParam.put("hallSensor", hallSensor);
            testedJsonParam.put("cpuPerformance", String.valueOf(cpuPerformanceStatus));
            testedJsonParam.put("DeviceTemperature", deviceTemperature);
            testedJsonParam.put("Fm_radio", fmradio);
            testedJsonParam.put("Proximity", proximity);
            testedJsonParam.put("Display_Touch_Screen", displayTouchScreen);
            testedJsonParam.put("Multifinger_test", multifingertest);
            testedJsonParam.put("Display_Brightness", displayBrightness);
            testedJsonParam.put("Earphone", earphone);
            testedJsonParam.put("Earphone_Jack", earphoneJack);
            testedJsonParam.put("handset_mic_keys", handsetmickeys);
            testedJsonParam.put("handset_mic", handsetmic);
            testedJsonParam.put("Microphone", microphone);
            testedJsonParam.put("NoiseCancellationTest", noiseCancellationTest);
            testedJsonParam.put("LoudSpeaker", loudSpeaker);
            testedJsonParam.put("Front_speaker", frontspeaker);
            testedJsonParam.put("Flash", flash);
            testedJsonParam.put("Front_camera_flash", frontcameraflash);
            testedJsonParam.put("Vibrate", vibrate);
            testedJsonParam.put("Volume_Up_Button", volumeUpButton);
            testedJsonParam.put("Volume_Down_Button", volumeDownButton);
            testedJsonParam.put("Home_Key", homeKey);
            testedJsonParam.put("Back_Key", backKey);
            testedJsonParam.put("Power_Key", powerKey);
            testedJsonParam.put("Screen_Lock", screenLock);
            testedJsonParam.put("Menu_Key", menuKey);
            testedJsonParam.put("USB", uSB);
            testedJsonParam.put("ChargingTest", chargingTest);
            testedJsonParam.put("OtgTest", otgTest);
            testedJsonParam.put("Biometric", biometric);
            testedJsonParam.put("NFC", nFC);
            testedJsonParam.put("Orientation", orientation);
            testedJsonParam.put("Call_SIM_1", callSIM1);
            testedJsonParam.put("Call_SIM_2", callSIM2);
            testedJsonParam.put("volteCallingTest", volteCallingTest);
            testedJsonParam.put("DEAD_PIXEL_CHECK", dEADPIXELCHECK);

            testedJsonObj = new JSONObject(testedJsonParam);

            System.out.println("All Data of tested Reports :- " + testedJsonObj.toString());
    ...
    private void setDataToTableForAllTest(String serviceKey) {
        try {
            ...
            if (password.equalsIgnoreCase("")) {
                System.out.println("First all test is :- " + allTest);
                ...
                param.put("device_id", str_DeviceID);  //  device_id
                ...
                System.out.println("Second all test is :- " + allTest);
        ...
        try {
            ...
            switch (view.getId()) {
                case R.id.startTestBattery:
                    ...
                    AllTestDataSaveActivity.this.finish();
                    break;
