...
public class FrontVideoRecordingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private File mImageFolder, mImageFile, mVideoFolder;
    ...
    private int bacKCameraRecording = 0, mTotalRotation;
    ...
    private String activity_Error = "No Error On Front Video Recording Activity Class";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_front_video_recording);
        ...
        ViewCompat.animate(FrontVideoRecordingActivity.this.scanGIF);
        ...
        switch (testName) {
            case "Front_Video_Recording":
                keyName = userSession.getFrontVideoRecordingTest();
                break;
        }
        ...
        try {
            countDownTimer1 = new CountDownTimer(3000, 1000) {
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    if (testName.equals("Back_Video_Recording") || testName.equals("Front_Video_Recording")) {
            ...
            exp.getStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 1 :- " + exp.getMessage() + ", " + exp.getCause();
    ...
    private void startTimer1() {
        try {
            ...
            exp.getStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 2 :- " + exp.getMessage() + ", " + exp.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
...
//                            mMediaRecorder.reset();
            ...
            exp.getStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 3 :- " + exp.getMessage() + ", " + exp.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
        ...
        try {
            countDownTimer3 = new CountDownTimer(3000, 1000) {
                public void onTick(long millisUntilFinished) {
                    ...
                    extratext2.setText("Playing video");
                }
                ...
                public void onFinish() {
                    ...
                    testResult();
                    Toast.makeText(FrontVideoRecordingActivity.this, "Finish", Toast.LENGTH_SHORT).show();
            ...
            exp.getStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 4 :- " + exp.getMessage() + ", " + exp.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    private void testResult() {
        try {
            Uri mVideoURI = Uri.fromFile(new File(mVideoFileName));
            if (testName.equals("Front_Video_Recording")) {
                if (mVideoURI != null) {
                ...
                editor.putString("Front_Video_Recording", keyValue);
                editor.apply();
                editor.commit();
                System.out.println("Front Video Recording Result :- " + keyValue);
                setSwitchActivitiesForNextTest();
            }
        } catch (Exception exp) {
            exp.getStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 5 :- " + exp.getMessage() + ", " + exp.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    private void setSwitchActivitiesForNextTest() {
        try {
            if (IsRetest.equalsIgnoreCase("Yes")) {
                ...
                FrontVideoRecordingActivity.this.finish();
//                setUpdatedResultsStatus(keyValue, keyName, serviceKey);
            ...
            exp.getStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 6 :- " + exp.getMessage() + ", " + exp.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    protected void onResume() {
        ...
        try {
            ...
            exp.getStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 7 :- " + exp.getMessage() + ", " + exp.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    protected void onPause() {
        try {
            ...
            exp.getStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 8 :- " + exp.getMessage() + ", " + exp.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    private void setupCamera(int width, int height) {
        ...
        try {
            ...
            e.printStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 9 :- " + e.getMessage() + ", " + e.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    private void connectCamera() {
        ...
        try {
            ...
            e.printStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 10 :- " + e.getMessage() + ", " + e.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    private void startRecord() {
        try {
            ...
            e.printStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 11 :- " + e.getMessage() + ", " + e.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    private void startPreview() {
        ...
        try {
            ...
            e.printStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 12 :- " + e.getMessage() + ", " + e.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    private void closeCamera() {
        try {
            ...
            exp.getStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 13 :- " + exp.getMessage() + ", " + exp.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    private void startBackgroundThread() {
        try {
            ...
            exp.getStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 14 :- " + exp.getMessage() + ", " + exp.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    private void stopBackgroundThread() {
        ...
        try {
            ...
            e.printStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 15 :- " + e.getMessage() + ", " + e.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    private void createVideoFolder() {
        try {
            ...
            exp.getStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 16 :- " + exp.getMessage() + ", " + exp.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    private void createImageFolder() {
        try {
            ...
            exp.getStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 17 :- " + exp.getMessage() + ", " + exp.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    private void startRecording() {
        try {
            ...
            e.printStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 18 :- " + e.getMessage() + ", " + e.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    private void checkWriteStoragePermission() {
        try {
            ...
            exp.getStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 19 :- " + exp.getMessage() + ", " + exp.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults) {
        try {
            ...
            exp.getStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 20 :- " + exp.getMessage() + ", " + exp.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    public void onBackPressed() {
        try {
            ...
            exp.getStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 21 :- " + exp.getMessage() + ", " + exp.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    public void onClick(View v) {
        try {
            ...
            exp.getStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 22 :- " + exp.getMessage() + ", " + exp.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
    ...
    public void play(String index) {
        try {
            ...
            MediaController mc = new MediaController(FrontVideoRecordingActivity.this);
            ...
            exp.getStackTrace();
            activity_Error = "FrontVideoRecordingActivity Exception 23 :- " + exp.getMessage() + ", " + exp.getCause();
            System.out.println(activity_Error);
            userSession.addError(activity_Error);
            errorTestReportShow.getUpdateErrorTestReport(activity_Error);
        }
