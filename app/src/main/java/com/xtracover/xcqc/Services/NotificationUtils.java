...
public class NotificationUtils {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "com.xtracover.xcqc.app";
    private static final String NOTIFICATION_CHANNEL_NAME = "com.xtracover.xcqc.app";
    ...
    private static Notification createNotification(@NonNull Context context) {
        ...
        builder.setContentText("Capturing..");
