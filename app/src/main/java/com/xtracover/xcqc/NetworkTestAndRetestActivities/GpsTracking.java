...
public class GpsTracking extends Service implements LocationListener {
    ...
    public Location getLocation() {
        try {
            ...
            e.printStackTrace();
            System.out.println("GpsTracking Exception 1 :- " + e.getMessage() + ", " + e.getCause());
        }
    ...
    public void showSettingsAlert() {
        try {
            ...
            alertDialog.setTitle("GPS is settings 1");   // Setting Dialog Title
...
// Showing Alert Message
            ...
            e.printStackTrace();
            System.out.println("GpsTracking Exception 2 :- " + e.getMessage() + ", " + e.getCause());
        }
    }
