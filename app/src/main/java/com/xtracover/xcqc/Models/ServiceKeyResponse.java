...
public class ServiceKeyResponse {
    ...
    @SerializedName("DATA")
    @Expose
    private List<ServiceKeyData> serviceKeyData;
    ...
    public List<ServiceKeyData> getServiceKeyData() {
        return serviceKeyData;
    }

    public void setServiceKeyData(List<ServiceKeyData> serviceKeyData) {
        this.serviceKeyData = serviceKeyData;
    }
