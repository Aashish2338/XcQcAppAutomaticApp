...
public class QCTestListByserviceKeyResponse {
    ...
    public List<QCTestListData> getQcTestListData() {
        return qcTestListData;
    }

    public void setQcTestListData(List<QCTestListData> qcTestListData) {
        this.qcTestListData = qcTestListData;
    }
